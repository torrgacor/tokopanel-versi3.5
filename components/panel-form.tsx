...
import { Check, Info, User, Mail, Package, Loader2, Settings, MessageSquare, Send } from "lucide-react"
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 pb-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-400 mt-2">Semua Panel Yang Di Sediakan Dari <span className="font-medium text-white">Server Private</span> (Server Lebih Stabil dan Tahan Lama)</p>
        <div className="space-y-3">
          ...
          <p className="text-xs text-gray-400 mt-2"><span className="font-medium text-white">⚡Express</span> = Menggunakan CPU Unlimited (Tidak Terbatas)</p>
                    ...
                    <div className={selectedPlan === plan.id ? "p-4" : ""}>
                      ...
                      <div className="flex justify-between items-start mb-2">
                        <h3 className="font-medium text-white text-sm flex-1 pr-2 flex items-center gap-2">
                          ...
                          }`}>{plan.type === "private" ? "Normal" : "Express"}</span>
                        </h3>
                      </div>
