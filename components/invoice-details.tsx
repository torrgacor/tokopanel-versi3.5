        ...
        <CardContent className="p-0">
          ...
          <div className="p-5 border-b border-dark-300">
            ...
            <div className="flex items-start space-x-3 mb-4">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-400">Jumlah Server</p>
                <p className="font-medium text-white text-lg">{quantity}</p>
              </div>
            </div>
            ...
            <div className="bg-dark-500 p-4 rounded-lg border border-dark-300">
              {plan ? (
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                  ...
                  {selectedEggName && (
                    <div>
                      <p className="text-gray-400">Egg</p>
                      <p className="font-medium text-white">{selectedEggName}</p>
                    </div>
                  )}
                </div>
              ) : (
          ...
          <div className="p-5">
            ...
            <div className="space-y-3">
              ...
              {selectedEggId && selectedEggPrice > 0 && (
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Biaya Egg ({selectedEggName}):</span>
                  <span className="text-red-400">+{formatRupiah(selectedEggPrice * quantity)}</span>
                </div>
              )}
